"""
Breakdown analysis of run6 eval results -- v2 (bugs fixed, moved from scratch/).
...
NUM_EVAL = 1_000
NODE_RANGE = (5, 20)
CKPT_PATH = os.path.join(_HERE, "..", "checkpoints_run6", "final.pt")
...
def main() -> None:
    ...
    print("=" * 62)
    print("RUN 6 -- BREAKDOWN ANALYSIS (v2)")
    print("=" * 62)
